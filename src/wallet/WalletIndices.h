...
namespace Pastella
{
    ...
    struct WalletRecord
    {
        ...
        Pastella::ITransfersContainer *container = nullptr;
...
#pragma pack(pop)
    ...
    typedef boost::multi_index_container<
        ...
        boost::multi_index::indexed_by<
            ...
            boost::multi_index::hashed_unique<
                ...
                BOOST_MULTI_INDEX_MEMBER(WalletRecord, Crypto::PublicKey, publicKey)>,
            boost::multi_index::hashed_unique<
                boost::multi_index::tag<TransfersContainerIndex>,
                BOOST_MULTI_INDEX_MEMBER(WalletRecord, Pastella::ITransfersContainer *, container)>>>
        WalletsContainer;
    ...
    typedef boost::multi_index_container<
        Pastella::WalletTransaction,
        boost::multi_index::indexed_by<
            boost::multi_index::random_access<boost::multi_index::tag<RandomAccessIndex>>,
            boost::multi_index::hashed_unique<
                boost::multi_index::tag<TransactionIndex>,
                boost::multi_index::
                    member<Pastella::WalletTransaction, Crypto::Hash, &Pastella::WalletTransaction::hash>>,
            boost::multi_index::ordered_non_unique<
                boost::multi_index::tag<BlockHeightIndex>,
                boost::multi_index::
                    member<Pastella::WalletTransaction, uint32_t, &Pastella::WalletTransaction::blockHeight>>>>
        WalletTransactions;

    typedef Common::FileMappedVector<EncryptedWalletRecord> ContainerStorage;

    typedef std::pair<uint64_t, Pastella::WalletTransfer> TransactionTransferPair;

    typedef std::vector<TransactionTransferPair> WalletTransfers;

    typedef std::map<uint64_t, Pastella::Transaction> UncommitedTransactions;
