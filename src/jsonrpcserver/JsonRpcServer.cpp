...
namespace Pastella
{
    ...
    void JsonRpcServer::processRequest(const Pastella::HttpRequest &req, Pastella::HttpResponse &resp)
    {
        try
        {
            ...
            if (req.getUrl() == "/json_rpc")
            {
                ...
                catch (std::runtime_error &)
                {
                    ...
                    resp.setStatus(Pastella::HttpResponse::STATUS_200);
            ...
            else
            {
                ...
                resp.setStatus(Pastella::HttpResponse::STATUS_404);
                return;
            }
        }
        catch (std::exception &e)
        {
            ...
            resp.setStatus(Pastella::HttpResponse::STATUS_500);
        }
    }
    ...
    void JsonRpcServer::makeErrorResponse(const std::error_code &ec, Common::JsonValue &resp)
    {
        ...
        JsonValue code;
        code = static_cast<int64_t>(Pastella::JsonRpc::errParseError); // Application specific error code
    ...
    void JsonRpcServer::makeMethodNotFoundResponse(Common::JsonValue &resp)
    {
        ...
        code = static_cast<int64_t>(
            Pastella::JsonRpc::errMethodNotFound); // ambigous declaration of JsonValue::operator= (between int and
                                                     // JsonValue)
    ...
    void JsonRpcServer::makeInvalidPasswordResponse(Common::JsonValue &resp)
    {
        ...
        JsonValue code;
        code = static_cast<int64_t>(Pastella::JsonRpc::errInvalidPassword);
    ...
    void JsonRpcServer::makeJsonParsingErrorResponse(Common::JsonValue &resp)
    {
        ...
        JsonValue error(JsonValue::OBJECT);
        JsonValue code;
        code = static_cast<int64_t>(Pastella::JsonRpc::errParseError); // ambigous declaration of JsonValue::operator=
