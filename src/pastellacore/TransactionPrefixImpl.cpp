...
#include "pastellacore/TransactionApiExtra.h"
...
namespace Pastella
{
    ...
    {
        return ::Pastella::getRequiredSignaturesCount(getInputChecked(m_txPrefix, inputIndex));
    }
    ...
    {
        return ::Pastella::findOutputsToAccount(m_txPrefix, addr, outs, outputAmount);
    }
