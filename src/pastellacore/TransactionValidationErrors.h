...
namespace Pastella
{
    namespace error
    {
            ...
            virtual std::string message(int ev) const
            {
                ...
                switch (code)
                {
                    ...
                    case TransactionValidationError::WRONG_FEE:
                        return "Transaction fee is below minimum fee";
                    case TransactionValidationError::SIZE_TOO_LARGE:
                        return "Transaction is too large (in bytes)";
                    case TransactionValidationError::GOVERNANCE_NOT_ENABLED:
                        return "Governance is not yet enabled";
                    default:
        ...
        inline std::error_code make_error_code(Pastella::error::TransactionValidationError e)
        {
            return std::error_code(
                static_cast<int>(e), Pastella::error::TransactionValidationErrorCategory::INSTANCE);
        }
...
namespace std
{
    template<> struct is_error_code_enum<Pastella::error::TransactionValidationError> : public true_type
    {
    };
