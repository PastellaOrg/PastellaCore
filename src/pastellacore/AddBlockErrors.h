...
namespace Pastella
{
    namespace error
    {
        ...
        inline std::error_code make_error_code(Pastella::error::AddBlockErrorCode e)
        {
            return std::error_code(static_cast<int>(e), Pastella::error::AddBlockErrorCategory::INSTANCE);
        }
...
namespace std
{
    template<> struct is_error_code_enum<Pastella::error::AddBlockErrorCode> : public true_type
    {
    };
