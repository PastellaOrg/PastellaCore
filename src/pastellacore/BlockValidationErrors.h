...
namespace Pastella
{
    namespace error
    {
        ...
        inline std::error_code make_error_code(Pastella::error::BlockValidationError e)
        {
            return std::error_code(static_cast<int>(e), Pastella::error::BlockValidationErrorCategory::INSTANCE);
        }
...
namespace std
{
    template<> struct is_error_code_enum<Pastella::error::BlockValidationError> : public true_type
    {
    };
