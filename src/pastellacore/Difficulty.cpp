...
{
    int64_t T = Pastella::parameters::DIFFICULTY_TARGET;
    int64_t N = Pastella::parameters::DIFFICULTY_WINDOW;
    ...
    {
        return Pastella::parameters::STARTING_DIFFICULTY;
    }
...
uint64_t nextDifficultyV3(std::vector<uint64_t> timestamps, std::vector<uint64_t> cumulativeDifficulties)
{
    int64_t T = Pastella::parameters::DIFFICULTY_TARGET;
    int64_t N = Pastella::parameters::DIFFICULTY_WINDOW;
    int64_t FTL = Pastella::parameters::PASTELLA_BLOCK_FUTURE_TIME_LIMIT;
    int64_t L(0), ST, sum_3_ST(0), next_D, prev_D;
