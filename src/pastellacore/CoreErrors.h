...
namespace Pastella
{
    namespace error
    {
        ...
        inline std::error_code make_error_code(Pastella::error::CoreErrorCode e)
        {
            return std::error_code(static_cast<int>(e), Pastella::error::CoreErrorCategory::INSTANCE);
        }
...
namespace std
{
    template<> struct is_error_code_enum<Pastella::error::CoreErrorCode> : public true_type
    {
    };
