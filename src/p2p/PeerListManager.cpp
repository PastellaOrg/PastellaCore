...
void PeerlistManager::serialize(Pastella::ISerializer &s)
{
...
void serialize(NetworkAddress &na, Pastella::ISerializer &s)
{
    s(na.ip, "ip");
    s(na.port, "port");
}

void serialize(PeerlistEntry &pe, Pastella::ISerializer &s)
{
    s(pe.adr, "adr");
    s(pe.id, "id");
...
PeerlistManager::PeerlistManager():
    m_whitePeerlist(m_peers_white, Pastella::P2P_LOCAL_WHITE_PEERLIST_LIMIT),
    m_grayPeerlist(m_peers_gray, Pastella::P2P_LOCAL_GRAY_PEERLIST_LIMIT)
{
}
