...
namespace Pastella
{
    ...
    class TransfersSyncronizer : public ITransfersSynchronizer, public IBlockchainConsumerObserver
    {
      public:
        ...
        virtual std::vector<Crypto::Hash> getKeyKnownBlocks(const Crypto::PublicKey &publicKey) override;
      ...
      private:
        ...
        bool findKeyForConsumer(IBlockchainConsumer *consumer, Crypto::PublicKey &publicKey) const;
