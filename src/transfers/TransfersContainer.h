...
namespace Pastella
{
    ...
    /* STEALTH ADDRESS REMOVAL: Changed KeyImage to PublicKey throughout */
    class SpentOutputDescriptor
    {
      public:
        ...
        SpentOutputDescriptor(const Crypto::PublicKey *publicKey);
        SpentOutputDescriptor(uint64_t amount, uint32_t globalOutputIndex);

        void assign(const Crypto::PublicKey *publicKey);
      ...
      private:
        ...
        union {
            const Crypto::PublicKey *m_publicKey;
            struct
            {
                uint64_t m_amount;
    ...
    {
        Crypto::PublicKey keyImage; //!< \attention Used only for TransactionTypes::OutputType::Key
    };
    ...
    struct TransactionOutputInformationEx : public TransactionOutputInformationIn
    {
        ...
        void serialize(Pastella::ISerializer &s)
        {
            ...
            /* STEALTH ADDRESS REMOVAL: keyImage renamed to publicKey */
    ...
    class TransfersContainer : public ITransfersContainer
    {
      ...
      private:
        ...
        /* STEALTH ADDRESS REMOVAL: Changed KeyImage to PublicKey */
        void updateTransfersVisibility(const Crypto::PublicKey &keyImage);
