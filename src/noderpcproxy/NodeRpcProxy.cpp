...
namespace Pastella
{
    ...
    {
        Pastella::COMMAND_RPC_GET_LAST_BLOCK_HEADER::request req = AUTO_VAL_INIT(req);
        Pastella::COMMAND_RPC_GET_LAST_BLOCK_HEADER::response rsp = AUTO_VAL_INIT(rsp);
        ...
        Pastella::COMMAND_RPC_GET_INFO::request getInfoReq = AUTO_VAL_INIT(getInfoReq);
        Pastella::COMMAND_RPC_GET_INFO::response getInfoResp = AUTO_VAL_INIT(getInfoResp);
    ...
    {
        Pastella::COMMAND_RPC_GET_FEE_ADDRESS::request ireq = AUTO_VAL_INIT(ireq);
        Pastella::COMMAND_RPC_GET_FEE_ADDRESS::response iresp = AUTO_VAL_INIT(iresp);
    ...
    bool NodeRpcProxy::addObserver(Pastella::INodeRpcProxyObserver *observer)
    {
        return m_rpcProxyObserverManager.add(observer);
    }

    bool NodeRpcProxy::removeObserver(Pastella::INodeRpcProxyObserver *observer)
    {
    ...
    void NodeRpcProxy::relayTransaction(const Pastella::Transaction &transaction, const Callback &callback)
    {
        std::lock_guard<std::mutex> lock(m_mutex);
    ...
    std::error_code NodeRpcProxy::doRelayTransaction(const Pastella::Transaction &transaction)
    {
    ...
    std::error_code NodeRpcProxy::doGetTransactionsStatus(
        ...
        std::unordered_set<Crypto::Hash> &transactionsUnknown)
    {
        Pastella::COMMAND_RPC_GET_TRANSACTIONS_STATUS::request req = AUTO_VAL_INIT(req);
        Pastella::COMMAND_RPC_GET_TRANSACTIONS_STATUS::response rsp = AUTO_VAL_INIT(rsp);
    ...
    std::error_code NodeRpcProxy::doQueryBlocksLite(
        ...
        uint64_t timestamp,
        std::vector<Pastella::BlockShortEntry> &newBlocks,
        uint32_t &startHeight)
    {
        Pastella::COMMAND_RPC_QUERY_BLOCKS_LITE::request req = AUTO_VAL_INIT(req);
        Pastella::COMMAND_RPC_QUERY_BLOCKS_LITE::response rsp = AUTO_VAL_INIT(rsp);
    ...
    std::error_code NodeRpcProxy::doGetWalletSyncData(
        ...
        std::vector<WalletTypes::WalletBlockInfo> &newBlocks)
    {
        Pastella::COMMAND_RPC_GET_WALLET_SYNC_DATA::request req = AUTO_VAL_INIT(req);
        Pastella::COMMAND_RPC_GET_WALLET_SYNC_DATA::response rsp = AUTO_VAL_INIT(rsp);
    ...
    std::error_code NodeRpcProxy::doGetPoolSymmetricDifference(
        ...
        std::vector<Crypto::Hash> &deletedTxIds)
    {
        Pastella::COMMAND_RPC_GET_POOL_CHANGES_LITE::request req = AUTO_VAL_INIT(req);
        Pastella::COMMAND_RPC_GET_POOL_CHANGES_LITE::response rsp = AUTO_VAL_INIT(rsp);
