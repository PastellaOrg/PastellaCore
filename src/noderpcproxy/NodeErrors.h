...
inline std::error_code make_error_code(Pastella::NodeError::NodeErrorCodes e)
{
    return std::error_code(static_cast<int>(e), Pastella::NodeError::NodeErrorCategory::INSTANCE);
}
