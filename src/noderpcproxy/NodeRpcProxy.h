...
namespace Pastella
{
    ...
    class NodeRpcProxy : public Pastella::INode
    {
      public:
        NodeRpcProxy(
        ...
        virtual bool addObserver(Pastella::INodeObserver *observer) override;

        virtual bool removeObserver(Pastella::INodeObserver *observer) override;

        virtual bool addObserver(Pastella::INodeRpcProxyObserver *observer);

        virtual bool removeObserver(Pastella::INodeRpcProxyObserver *observer);
        ...
        virtual void relayTransaction(const Pastella::Transaction &transaction, const Callback &callback) override;
      ...
      private:
        ...
        std::error_code doRelayTransaction(const Pastella::Transaction &transaction);
      ...
      private:
        ...
        Tools::ObserverManager<Pastella::INodeObserver> m_observerManager;

        Tools::ObserverManager<Pastella::INodeRpcProxyObserver> m_rpcProxyObserverManager;
