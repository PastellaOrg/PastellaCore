...
inline std::error_code make_error_code(Pastella::error::BlockchainExplorerErrorCodes e)
{
    return std::error_code(static_cast<int>(e), Pastella::error::BlockchainExplorerErrorCategory::INSTANCE);
}
